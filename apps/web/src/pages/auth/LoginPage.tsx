          ...
          <div className="mt-6 pt-5 border-t border-slate-100">
            ...
            <div className="grid grid-cols-1 gap-2 text-left">
              <button
                ...
                className="p-2.5 rounded-xl bg-slate-50 hover:bg-slate-100 text-[11px] text-slate-600 border border-slate-200 transition-colors flex items-center justify-between"
              >
                <div>
